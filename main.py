...
def get_my_verifed_work(devman_api_key, timestamp=None):
...
def telegram_bot(bot, chat_id, devman_api_key):
	timestamp = None
	while True:
		my_work = get_my_verifed_work(devman_api_key, timestamp=timestamp)
...
def main():
	...
	telegram_bot(bot, my_chat_id, devman_api_key)
